...
def do_check_id(cls, review_id):
    """If review_id is not linked to any Review object, raise a 404 error"""
    try:
...
def do_delete_review(review_id):
    """Deletes a Review object - Return: an empty dict with status code 200"""
...
def do_create_review(request, place_id):
    """Creates a review object - Return: new review object"""
